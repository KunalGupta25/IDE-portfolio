...
export function HomeContent({ profile }: { profile: any }) {
  return (
    <div className="flex w-full max-w-4xl flex-col space-y-6">
      <TypeWriter
        text={profile.bio || `Hi, I'm ${profile.name}`}
      ...
      <p className="text-lg text-slate-400">
        {profile.bioExtended || "I believe that great software is born from a combination of technical excellence and creative innovation. Let's build something amazing together."}
      </p>
      <NavigationButtons />
